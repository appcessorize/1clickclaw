...
# docker build -t clawsaas .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name clawsaas clawsaas
...
RUN yarn install --immutable && bun install
